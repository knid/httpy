...
Thanks to its programmable structure, it can perform many tasks at the same time.
For example, you can extract data for user IDs 0, 1, and 2 at the same time
